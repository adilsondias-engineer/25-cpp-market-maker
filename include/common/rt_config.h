...
struct ThreadConfig {
    ...
    // CPU core assignments (isolated cores: 4-23)
    static constexpr int UDP_LISTENER_CPU = 9;          // Core 9 - UDP receive + parse
    static constexpr int MARKET_MAKER_CPU = 10;         // Core 10 - Market maker FSM
