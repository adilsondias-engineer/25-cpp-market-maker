...
/**
 * Order Producer - Sends orders to Project 26 via Disruptor
 * Also consumes fill notifications from Project 26
 */
class OrderProducer {
public:
    ...
    // Send order to Project 26
    void send_order(const trading::OrderRequest& order);

    // Try to read fill notification from Project 26
